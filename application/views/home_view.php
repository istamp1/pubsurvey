...
<div id="container">
    ...
    <?php $this->load->view('header_view', array( 'selected' => 'Home', 'forename' => $forename, 'branch' => $branch ) ); ?>
    ...
    <div id="body">
        ...
        <div id="main_content">
            ...
            <p class="normal">Welcome to the Norwich & Norfolk CAMRA's Pub Survey website. 
                The third annual survey will take place in late June, when we hope to beat last year's 
                score of 263 different beers. 
            <p class="normal">On the day, we'll visit every one of the 150+ pubs in Norwich to
                discover which beers and ciders are on sale. The data will  
                be entered using this website during the day - you'll see the running totals above.
            <h1>Area covered</h1>
            <p class="normal">The survey covers the city centre and suburbs, postcodes NR1 - NR7 plus 
                a few pubs in other postcodes but which would generally considered to be in Norwich.
